...
('comp1@fenix.com', '1234Abcd$', 'Juan', 'Perez', 'EMPRESA', '2023-01-10 10:00:00', TRUE),
('comp2@fenix.com', '1234Abcd$', 'Maria', 'Gomez', 'EMPRESA', '2023-01-15 11:00:00', TRUE),
('comp3@fenix.com', '1234Abcd$', 'Carlos', 'Ruiz', 'EMPRESA', '2023-02-01 09:30:00', TRUE),
('comp4@fenix.com', '1234Abcd$', 'Ana', 'Lopez', 'EMPRESA', '2023-02-20 14:00:00', TRUE),
('comp5@fenix.com', '1234Abcd$', 'Luis', 'Torres', 'EMPRESA', '2023-03-05 16:20:00', TRUE),
('comp6@fenix.com', '1234Abcd$', 'Elena', 'Diaz', 'EMPRESA', '2023-03-15 08:45:00', FALSE),
('comp7@fenix.com', '1234Abcd$', 'Pedro', 'Sanchez', 'EMPRESA', '2023-04-01 12:00:00', TRUE),
('comp8@fenix.com', '1234Abcd$', 'Sofia', 'Martin', 'EMPRESA', '2023-04-10 10:15:00', TRUE),
('comp9@fenix.com', '1234Abcd$', 'Miguel', 'Hernandez', 'EMPRESA', '2023-05-05 11:30:00', FALSE),
('comp10@fenix.com', '1234Abcd$', 'Lucia', 'Jimenez', 'EMPRESA', '2023-05-20 15:45:00', FALSE),
('comp11@fenix.com', '1234Abcd$', 'David', 'Alvarez', 'EMPRESA', '2023-06-01 09:00:00', TRUE),
('comp12@fenix.com', '1234Abcd$', 'Carmen', 'Moreno', 'EMPRESA', '2023-06-15 13:20:00', TRUE),
('comp13@fenix.com', '1234Abcd$', 'Jorge', 'Munoz', 'EMPRESA', '2023-07-01 17:00:00', TRUE),
('comp14@fenix.com', '1234Abcd$', 'Raquel', 'Romero', 'EMPRESA', '2023-07-20 10:30:00', FALSE),
('comp15@fenix.com', '1234Abcd$', 'Alberto', 'Navarro', 'EMPRESA', '2023-08-05 14:15:00', TRUE),
('user1@fenix.com', '1234Abcd$', 'Laura', 'Gil', 'PARTICULAR', '2023-08-15 16:00:00', FALSE),
('user2@fenix.com', '1234Abcd$', 'Roberto', 'Serrano', 'PARTICULAR', '2023-09-01 09:45:00', FALSE),
('user3@fenix.com', '1234Abcd$', 'Isabel', 'Blanco', 'PARTICULAR', '2023-09-20 11:15:00', TRUE),
('user4@fenix.com', '1234Abcd$', 'Fernando', 'Molina', 'PARTICULAR', '2023-10-05 13:30:00', FALSE),
('admin@fenix.com', '1234Abcd$', 'Admin', 'System', 'ADMIN', '2023-01-01 00:00:00', TRUE);

-- Companies (15 records)
INSERT INTO companies (user_id, company_name, cif, reputation_score, impact_metrics) VALUES
(1, 'Tech Solutions', 'B1111111A', 100, '{"environmental": {"totalCo2SavedKg": 50.5}, "social": {"itemsDonated": 10}}'),
(2, 'Green Hardware', 'B2222222A', 200, '{"environmental": {"totalCo2SavedKg": 120.0}, "social": {"itemsDonated": 25}}'),
(3, 'Recycle IT', 'B3333333C', 150, '{"environmental": {"totalCo2SavedKg": 80.2}, "social": {"itemsDonated": 15}}'),
(4, 'Second Life PC', 'B4444444C', 300, '{"environmental": {"totalCo2SavedKg": 200.5}, "social": {"itemsDonated": 40}}'),
(5, 'EcoComp', 'B5555555F', 50, '{"environmental": {"totalCo2SavedKg": 20.0}, "social": {"itemsDonated": 5}}'),
(6, 'Future Tech', 'B6666666H', 120, '{"environmental": {"totalCo2SavedKg": 60.0}, "social": {"itemsDonated": 12}}'),
(7, 'Hardware Heroes', 'B7777777I', 180, '{"environmental": {"totalCo2SavedKg": 90.5}, "social": {"itemsDonated": 18}}'),
(8, 'Sustainable Systems', 'B8888888D', 250, '{"environmental": {"totalCo2SavedKg": 150.0}, "social": {"itemsDonated": 30}}'),
(9, 'ReNew Devices', 'B9999999E', 80, '{"environmental": {"totalCo2SavedKg": 40.0}, "social": {"itemsDonated": 8}}'),
(10, 'Circular Electronics', 'B1010101A', 220, '{"environmental": {"totalCo2SavedKg": 130.5}, "social": {"itemsDonated": 28}}'),
(11, 'Green Chip', 'B1212121F', 110, '{"environmental": {"totalCo2SavedKg": 55.0}, "social": {"itemsDonated": 11}}'),
(12, 'Eco Parts', 'B1313131G', 160, '{"environmental": {"totalCo2SavedKg": 85.0}, "social": {"itemsDonated": 16}}'),
(13, 'Tech Cycle', 'B1414141I', 280, '{"environmental": {"totalCo2SavedKg": 180.0}, "social": {"itemsDonated": 35}}'),
(14, 'Planet PC', 'B1515151C', 90, '{"environmental": {"totalCo2SavedKg": 45.0}, "social": {"itemsDonated": 9}}'),
(15, 'BioBytes', 'B1616161A', 140, '{"environmental": {"totalCo2SavedKg": 70.0}, "social": {"itemsDonated": 14}}');
